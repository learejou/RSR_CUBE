...
urlpatterns = [
    ...
    path('activate_ressource/<str:id>', views.activate_ressource, name='activate_ressource'),
    path('refuse_ressource/<str:id>', views.refuse_ressource, name='refuse_ressource'),
    ...
    path('profil/edit_profil/', views.edit_profil, name="edit_profil"),
    path('profil/edit_password/', views.edit_password, name="edit_password"),
]
